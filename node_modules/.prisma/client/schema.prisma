...
//   status    String   // Table status (e.g., "Available", "Reserved", "Occupied")
//   reservations Reservation[]
// }
...
model Reservation {
  ...
  service   String // Type of service (e.g., "Dine-in", "Takeout", etc.)
  status    String // Status of the reservation (e.g., "Pending", "Confirmed", "Canceled")
  user      User     @relation(fields: [userId], references: [id])
  userId    Int
  // table     Table?   @relation(fields: [tableId], references: [id]) // New relationship to Table
  // tableId   Int?
  createdAt DateTime @default(now()) // Timestamp for when the reservation was created
  updatedAt DateTime @updatedAt // Automatically updates when the reservation is modified
